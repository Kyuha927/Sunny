...
---
# Wine 11, 커널 수준에서 Linux의 Windows 게임 실행 방식을 재작성해 대규모...

> **출처**: GeekNews | **날짜**: 2026-03-25 | [원문 링크](https://www.xda-developers.com/wine-11-rewrites-linux-runs-windows-games-speed-gains/)

---

# Wine 11 rewrites how Linux runs Windows games at the kernel level, and the speed gains are massive

![A computer screen showing Windows apps running on Ubuntu through Wine](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/09/windows-apps-through-wine.jpg?&fit=crop&w=1600&h=900)
...
By 
[Adam Conway](/author/adamconway-xda/)

Published Mar 23, 2026, 12:31 PM EDT
...
[Add Us On](https://www.google.com/preferences/source?q=xda-developers.com "Add Us On")
...
![Screenshot of PhotoFiltre 7 running on Ubuntu through Wine](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/09/photofiltre-7-in-wine.png?q=49&fit=crop&w=825&dpr=2)
...
Fsync came next, using Linux futexes for even better performance. It was faster than esync in most cases, but it required out-of-tree kernel patches that never made it into the mainline Linux kernel or to [upstream Wine out of the box](https://bugs.winehq.org/show_bug.cgi?id=50281). That meant you needed a custom or patched kernel to use it, which is fine for enthusiasts running CachyOS or Proton-GE, but not exactly accessible for the average user on Ubuntu or Fedora. Futex2, often referred to interchangeably with fsync, *did* make it to Linux kernel 5.16 as futex\_waitv, but the original implementation of fsync isn't that. Fsync used futex\_wait\_multiple, and Futex2 used futex\_waitv. Applications such as Lutris still refer to it as Fsync, though. It's still *kind of* fsync, but it's not the *original* fsync.
...
![Steam-Deck-Half-Life-In-Hand](https://static0.xdaimages.com/wordpress/wp-content/uploads/2022/10/Steam-Deck-Half-Life-In-Hand.jpg?q=49&fit=crop&w=825&dpr=2)
...
The numbers are wild. In developer [benchmarks](https://lwn.net/Articles/960275/), Dirt 3 went from 110.6 FPS to 860.7 FPS, which is an impressive 678% improvement. Resident Evil 2 jumped from 26 FPS to 77 FPS. Call of Juarez went from 99.8 FPS to 224.1 FPS. Tiny Tina's Wonderlands saw gains from 130 FPS to 360 FPS. As well, Call of Duty: Black Ops I is now [*actually* playable](https://www.reddit.com/r/linux_gaming/comments/1kfoa5c/psa_ntsync_makes_black_ops_1_playable_at_full/) on Linux, too. Those benchmarks compare Wine NTSYNC against upstream vanilla Wine, which means there's no fsync or esync either. Gamers who use fsync are not going to see such a leap in performance in most games.
...
![steam-proton-gaming-bazzite (2)](https://static0.xdaimages.com/wordpress/wp-content/uploads/2026/02/steam-proton-gaming-bazzite-2.jpg?q=49&fit=crop&w=825&dpr=2)
...
[Facebook](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F%2F&src=sdkpreparse)
[X](https://twitter.com/intent/tweet?text=Wine%2011%20rewrites%20how%20Linux%20runs%20Windows%20games%20at%20the%20kernel%20level%2C%20and%20the%20speed%20gains%20are%20massive&url=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F)
[WhatsApp](https://web.whatsapp.com/send?text=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F)
[Threads](https://www.threads.net/intent/post?text=Wine%2011%20rewrites%20how%20Linux%20runs%20Windows%20games%20at%20the%20kernel%20level%2C%20and%20the%20speed%20gains%20are%20massive%20https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F)
[Bluesky](https://bsky.app/intent/compose?text=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F)
[LinkedIn](https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F&title=Wine%2011%20rewrites%20how%20Linux%20runs%20Windows%20games%20at%20the%20kernel%20level%2C%20and%20the%20speed%20gains%20are%20massive&source=www.xda-developers.com&summary=Wine%2011%20is%20the%20biggest%20jump%20for%20Linux%20gaming%20in%20years.)
[Reddit](https://www.reddit.com/submit?url=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F)
[Flipboard](http://share.flipboard.com/bookmarklet/popout?v=2&title=Wine%2011%20rewrites%20how%20Linux%20runs%20Windows%20games%20at%20the%20kernel%20level%2C%20and%20the%20speed%20gains%20are%20massive&url=https%3A%2F%2Fwww.xda-developers.com%2Fwine-11-rewrites-linux-runs-windows-games-speed-gains%2F&utm_campaign=tools&utm_medium=article-share&utm_source=www.xda-developers.com)
[Copy link](javascript:;)
[Email](mailto:?Subject=Wine 11 rewrites how Linux runs Windows games at the kernel level, and the speed gains are massive&Body=Check%20this%20out%21%0Ahttps://www.xda-developers.com/wine-11-rewrites-linux-runs-windows-games-speed-gains/)

Close

Trending Now

[![A Windows 11 laptop showing a OneDrive folder and Storage Sense settings](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/11/onedrive-files-on-demand-and-storage-sense.jpg?q=49&fit=crop&w=100&h=67&dpr=2)](/4-windows-11-startup-apps-i-disabled-to-instantly-speed-up-my-pc/)

##### [4 Windows 11 startup apps I disabled to instantly speed up my PC](/4-windows-11-startup-apps-i-disabled-to-instantly-speed-up-my-pc/ "4 Windows 11 startup apps I disabled to instantly speed up my PC")

[![CachyOS setup-3](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2025/10/cachyos-setup-3.jpg?q=49&fit=crop&w=100&h=67&dpr=2)](/cachyos-dethrones-arch-as-the-top-desktop-distro-for-linux-gamers-on-protondb/)

##### [CachyOS dethrones Arch as the top desktop distro for Linux gamers on ProtonDB](/cachyos-dethrones-arch-as-the-top-desktop-distro-for-linux-gamers-on-protondb/ "CachyOS dethrones Arch as the top desktop distro for Linux gamers on ProtonDB")

[![An NVIDIA RTX 2070 Super next to a gaming PC with the NVIDIA App in the background.](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/01/nvidia-rtx-2070-super-propped-gaming-pc-nvidia-app-in-background.jpg?q=49&fit=crop&w=100&h=67&dpr=2)](/the-nvidia-apps-game-optimizer-is-not-appreciated-enough/)

##### [The NVIDIA App's Game Optimizer is genuinely magic, and it's not appreciated enough](/the-nvidia-apps-game-optimizer-is-not-appreciated-enough/ "The NVIDIA App's Game Optimizer is genuinely magic, and it's not appreciated enough")
